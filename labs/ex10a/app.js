...
function setup(shaders)
{
    ...
    gl.bufferData(gl.ARRAY_BUFFER, (vertices.length*2+colors.length*4)*4, gl.STATIC_DRAW);
    gl.bufferSubData(gl.ARRAY_BUFFER, 0, flatten(vertices));
    gl.bufferSubData(gl.ARRAY_BUFFER, vertices.length*2*4, flatten(colors))
    ...
    gl.vertexAttribPointer(vColor, 4, gl.FLOAT, false, 0, vertices.length*2*4);
